...
CREATE  TABLE "public".department_needs ( 
	...
	CONSTRAINT fk_department_needs_need_details FOREIGN KEY ( id ) REFERENCES "public".need_details( id_department_needs ) ON DELETE CASCADE ON UPDATE CASCADE 
 );
...
CREATE  TABLE "public".proforma ( 
	...
	CONSTRAINT fk_proforma_proforma_details FOREIGN KEY ( id ) REFERENCES "public".proforma_details( id_proforma ) ON DELETE CASCADE ON UPDATE CASCADE ,
...
CREATE  TABLE "public".supplier ( 
	...
	CONSTRAINT fk_supplier_article_supplier FOREIGN KEY ( id ) REFERENCES "public".article_supplier( id_supplier ) ON DELETE CASCADE ON UPDATE CASCADE ,
	CONSTRAINT fk_supplier_proforma FOREIGN KEY ( id ) REFERENCES "public".proforma( id_supplier ) ON DELETE CASCADE ON UPDATE CASCADE 
 );
...
CREATE  TABLE "public".article ( 
	...
	CONSTRAINT fk_article_article_supplier FOREIGN KEY ( id ) REFERENCES "public".article_supplier( id_article ) ON DELETE CASCADE ON UPDATE CASCADE ,
	...
	CONSTRAINT fk_article_proforma_details FOREIGN KEY ( id ) REFERENCES "public".proforma_details( id_article ) ON DELETE CASCADE ON UPDATE CASCADE ,
	CONSTRAINT "fk_article_purchase order_details" FOREIGN KEY ( id ) REFERENCES "public"."purchase order_details"( id_article ) ON DELETE CASCADE ON UPDATE CASCADE 
 );
...
CREATE  TABLE "public".department ( 
	...
	CONSTRAINT fk_department_department_needs FOREIGN KEY ( id ) REFERENCES "public".department_needs( id_department ) ON DELETE CASCADE ON UPDATE CASCADE 
 );
