...
public partial class CommercialSystemContext : DbContext
{
    ...
    public virtual DbSet<ArticleSupplier> ArticleSuppliers { get; set; }

    public virtual DbSet<Company> Companies { get; set; }

    public virtual DbSet<Department> Departments { get; set; }

    public virtual DbSet<DepartmentNeed> DepartmentNeeds { get; set; }

    public virtual DbSet<MoinsDisant> MoinsDisants { get; set; }

    public virtual DbSet<NeedDetail> NeedDetails { get; set; }

    public virtual DbSet<NeedGroup> NeedGroups { get; set; }

    public virtual DbSet<NeedGroupNeed> NeedGroupNeeds { get; set; }

    public virtual DbSet<Proforma> Proformas { get; set; }

    public virtual DbSet<ProformaDetail> ProformaDetails { get; set; }

    public virtual DbSet<ProformaSend> ProformaSends { get; set; }

    public virtual DbSet<ProformaSendNeedGroup> ProformaSendNeedGroups { get; set; }
    ...
    public virtual DbSet<VBesoin> VBesoins { get; set; }

    public virtual DbSet<VBesoinAAfficher> VBesoinAAffichers { get; set; }

    public virtual DbSet<VBesoinAGrouper> VBesoinAGroupers { get; set; }

    public virtual DbSet<VGroupNonProformer> VGroupNonProformers { get; set; }

    public virtual DbSet<VGroupProformer> VGroupProformers { get; set; }

    public virtual DbSet<VGroupProformerDetail> VGroupProformerDetails { get; set; }

    public virtual DbSet<VProforma> VProformas { get; set; }

    public virtual DbSet<VProformaDetail> VProformaDetails { get; set; }

    public virtual DbSet<VProformaSend> VProformaSends { get; set; }

    public virtual DbSet<VProformaSendNeedGroup> VProformaSendNeedGroups { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_article_supplier");
            ...
            entity.HasOne(d => d.IdArticleNavigation).WithMany(p => p.ArticleSuppliers)
                .HasForeignKey(d => d.IdArticle)
                .HasConstraintName("fk_article_supplier_article");

            entity.HasOne(d => d.IdSupplierNavigation).WithMany(p => p.ArticleSuppliers)
        ...
        modelBuilder.Entity<DepartmentNeed>(entity =>
        {
            ...
            entity.HasOne(d => d.IdDepartmentNavigation).WithMany(p => p.DepartmentNeeds)
                .HasForeignKey(d => d.IdDepartment)
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_need_details");
            ...
            entity.HasOne(d => d.IdArticleNavigation).WithMany(p => p.NeedDetails)
                .HasForeignKey(d => d.IdArticle)
                .HasConstraintName("fk_need_details_article");

            entity.HasOne(d => d.IdDepartmentNeedsNavigation).WithMany(p => p.NeedDetails)
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_need_group");
            ...
            entity.HasOne(d => d.IdArticleNavigation).WithMany(p => p.NeedGroups)
                .HasForeignKey(d => d.IdArticle)
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_need_group_need");
            ...
            entity.HasOne(d => d.IdNeedDetailsNavigation).WithMany(p => p.NeedGroupNeeds)
                .HasForeignKey(d => d.IdNeedDetails)
                .HasConstraintName("fk_need_group_need_need_details");

            entity.HasOne(d => d.IdNeedGroupNavigation).WithMany(p => p.NeedGroupNeeds)
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_proformat");
            ...
            entity.HasOne(d => d.IdProformaSendNavigation).WithMany(p => p.Proformas)
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_proformat_details");
            ...
            entity.HasOne(d => d.IdArticleNavigation).WithMany(p => p.ProformaDetails)
                .HasForeignKey(d => d.IdArticle)
                .HasConstraintName("fk_proforma_details_article");

            entity.HasOne(d => d.IdNeedGroupNavigation).WithMany(p => p.ProformaDetails)
                .HasForeignKey(d => d.IdNeedGroup)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("fk_proforma_details_need_group");

            entity.HasOne(d => d.IdProformaNavigation).WithMany(p => p.ProformaDetails)
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_proforma_send");
            ...
            entity.HasOne(d => d.IdSupplierNavigation).WithMany(p => p.ProformaSends)
                .HasForeignKey(d => d.IdSupplier)
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_proforma_send_details");
            ...
            entity.HasOne(d => d.IdNeedGroupNavigation).WithMany(p => p.ProformaSendNeedGroups)
                .HasForeignKey(d => d.IdNeedGroup)
                .HasConstraintName("fk_proforma_send_details_need_group");

            entity.HasOne(d => d.IdProformaSendNavigation).WithMany(p => p.ProformaSendNeedGroups)
                .HasForeignKey(d => d.IdProformaSend)
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_purchase_order");
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_purchase order_details");

            entity.ToTable("purchase_order_details");

            entity.HasIndex(e => e.IdArticle, "unq_purchase order_details_id_article").IsUnique();
            ...
            entity.HasOne(d => d.IdArticleNavigation).WithOne(p => p.PurchaseOrderDetail)
        ...
        modelBuilder.Entity<VGroupProformerDetail>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("v_group_proformer_details");
        ...
        modelBuilder.Entity<VProformaSendNeedGroup>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("v_proforma_send_need_group");
